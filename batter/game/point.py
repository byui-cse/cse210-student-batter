class Point:
    ...
    def reverse_x(self):
        """Gets a new Point that reverses the horizontal direction.
        
        Returns:
            Point: A new Point that is reversed horizontally.
        """
        x = self._x * -1
        y = self._y
        return Point(x, y)
    ...
    def reverse_y(self):
        """Gets a new Point that reverses the vertical direction.
